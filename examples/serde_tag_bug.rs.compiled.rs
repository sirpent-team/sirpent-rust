...
const _IMPL_DESERIALIZE_FOR_A: () =
    {
        ...
        impl _serde::Deserialize for A {
            fn deserialize<__D>(deserializer: __D)
             -> _serde::export::Result<A, __D::Error> where
                    ...
                    __Field::__field0 => {
                        ...
                        impl _serde::de::Visitor for __Visitor {
                            ...
                            fn visit_map<__V>(self, mut visitor: __V)
                             -> _serde::export::Result<A, __V::Error> where
                             __V: _serde::de::MapVisitor {
                                let mut __field0: _serde::export::Option<B> =
                                    _serde::export::None;
        ...
        impl _serde::Serialize for B {
            fn serialize<__S>(&self, _serializer: __S)
             ...
             __S: _serde::Serializer {
                match *self {
                    B::B1 =>
                    _serde::Serializer::serialize_unit_variant(_serializer,
                                                               "B", 0usize,
                                                               "B1"),
                    B::B2 =>
                    _serde::Serializer::serialize_unit_variant(_serializer,
...
const _IMPL_DESERIALIZE_FOR_B: () =
    {
        ...
        impl _serde::Deserialize for B {
            fn deserialize<__D>(deserializer: __D)
             -> _serde::export::Result<B, __D::Error> where
             __D: _serde::Deserializer {
                #[allow(non_camel_case_types)]
                enum __Field { __field0, __field1, }
                impl _serde::Deserialize for __Field {
                ...
                impl _serde::de::Visitor for __Visitor {
                    ...
                    fn visit_enum<__V>(self, visitor: __V)
                     -> _serde::export::Result<B, __V::Error> where
                ...
                _serde::Deserializer::deserialize_enum(deserializer, "B",
                                                       VARIANTS, __Visitor)
            }
        }
    };
